...
namespace ofxCv {
	...
	std::vector<glm::vec2> toOf(const std::vector<cv::Point_<int>>& points) {
		std::vector<glm::vec2> out(points.size());
		for(int i = 0; i < points.size(); i++) {
			out[i].x = points[i].x;
			out[i].y = points[i].y;
		}
	...
	std::vector<glm::vec2> toOf(const std::vector<cv::Point2f>& points) {
		std::vector<glm::vec2> out(points.size());
		for(int i = 0; i < points.size(); i++) {
			out[i].x = points[i].x;
			out[i].y = points[i].y;
	...
	std::vector<glm::vec3> toOf(const std::vector<cv::Point3f>& points) {
		std::vector<glm::vec3> out(points.size());
		for(int i = 0; i < points.size(); i++) {
			out[i].x = points[i].x;
			out[i].y = points[i].y;
			out[i].z = points[i].z;
